...
#   .\run.ps1 app             -> fr.esgi.kafka.tp11.CurrencyAggregator   (votre agregation ; tourne en continu)
#   .\run.ps1 app solution    -> fr.esgi.kafka.tp11.solution.CurrencyAggregator (corrige)
#   .\run.ps1 seed            -> fr.esgi.kafka.tp11.OrderProducer        (envoie des commandes de demo)
#
# Demo tolerance aux pannes : lancez "app", "seed", observez, arretez (Ctrl-C),
# relancez "app" -> les totaux sont restaures depuis le changelog (pas de remise a zero).
