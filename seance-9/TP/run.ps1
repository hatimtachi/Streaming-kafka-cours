...
#   .\run.ps1 app             -> fr.esgi.kafka.tp9.OrderStreamApp   (votre topologie ; tourne en continu)
#   .\run.ps1 app solution    -> fr.esgi.kafka.tp9.solution.OrderStreamApp (corrige)
#   .\run.ps1 seed            -> fr.esgi.kafka.tp9.OrderProducer    (envoie des commandes de demo)
#
