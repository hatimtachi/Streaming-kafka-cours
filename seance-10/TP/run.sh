...
#   ./run.sh app             -> fr.esgi.kafka.tp10.OrderRouterApp   (votre topologie ; tourne en continu)
#   ./run.sh app solution    -> fr.esgi.kafka.tp10.solution.OrderRouterApp (corrige)
#   ./run.sh seed            -> fr.esgi.kafka.tp10.OrderProducer    (envoie des commandes de demo)
#
